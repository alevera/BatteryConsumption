...
#ifndef batteryconsumption_HEADER
#define batteryconsumption_HEADER
...
class batteryconsumption : public Plasma::Applet
{
    Q_OBJECT
    public:
        // Basic Create/Destroy
        batteryconsumption(QObject *parent, const QVariantList &args);
        ~batteryconsumption();
...
K_EXPORT_PLASMA_APPLET(batteryconsumption, batteryconsumption)
#endif
